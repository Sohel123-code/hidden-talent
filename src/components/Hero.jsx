        ...
        <section className="relative h-screen w-full flex items-center justify-center overflow-hidden bg-white">
            ...
            <div className="relative z-20 text-center px-6">
                ...
                <motion.h1
                    ...
                    className="text-5xl md:text-9xl font-accent font-black tracking-tighter text-gray-900 mb-4"
                >
                ...
                <motion.div
                    ...
                    className="h-1 md:h-[6px] w-16 md:w-24 bg-primary mx-auto mb-6 md:mb-8 origin-center"
                ></motion.div>
                ...
                <motion.p
                    ...
                    className="text-sm md:text-2xl font-light tracking-[0.2em] text-gray-500 uppercase"
                >
